...
/**
 * @extends ServiceEntityRepository<Declinaison>
 *
...
class DeclinaisonRepository extends ServiceEntityRepository
{
    ...
    public function add(Declinaison $entity, bool $flush = false): void
    {
    ...
    public function remove(Declinaison $entity, bool $flush = false): void
    {
